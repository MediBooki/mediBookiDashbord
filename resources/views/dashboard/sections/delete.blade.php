<!-- Modal -->
<div class="modal fade text-left" id="delete{{$section->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel27"
    aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title" id="myModalLabel27">{{ trans('main-sidebar.Delete')}} {{ trans('main-sidebar.sections') }}</h1>
          ...
          <form action="{{ route('sections.destroy', 'test') }}" method="post" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <h2>هل انت تريد حذف قسم {{ $section->name }} </h2>
            </div>
