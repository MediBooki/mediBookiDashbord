<!-- Modal -->
<div class="modal fade text-left" id="add_review{{ $invoice->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel27"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('add.review') }}" method="post" autocomplete="off">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="projectinput1"> {{ trans('diagnosis.review_date') }}</label>
                                <input type="date" name="review_date" id="datetimepicker1" class="form-control" />
                                @error("review_date")
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
