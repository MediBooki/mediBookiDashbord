<!-- Modal -->
<div class="modal fade text-left" id="delete{{$invoice->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel27"
    aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title" id="myModalLabel27">{{ trans('main-sidebar.Delete')}} {{ trans('main-sidebar.invoice') }}</h1>
          ...
          <form action="{{ route('invoices.destroy', 'test') }}" method="post" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <h2>{{trans('invoice.invoice_delete')}}  {{ $invoice->driver_name }} </h2>
            </div>
