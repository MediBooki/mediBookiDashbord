<!-- Modal -->
<div class="modal fade text-left" id="delete{{$category->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel27"
    aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <form action="{{ route('categories.destroy', 'test') }}" method="post" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <h2>{{trans('category.category_delete')}} {{ $category->name }} </h2>
            </div>
